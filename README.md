...
### מבנה אירוע
- **כותרת (תנאים טובים):** "חלון גלישה טוב - הרצליה"
- **כותרת (תנאים שהידרדרו):** "חלון גלישה - התנאים נחלשו"
- **תאריך:** אירוע אחד לכל היותר ליום
- **שעה:** משתמש בחלון הזמן הטוב ביותר:
  - בוקר: 6:00 - 10:00
  - ערב: 16:00 - 19:00
  - אם **שני** החלונות טובים, נוצר אירוע לחלון הבוקר
- **תיאור (עברית):** תבנית ברורה וקצרה:

```
חלון גלישה טוב בהרצליה

נתונים:
• גובה גל: X.X מטר
• תקופה: X שניות
• רוח: כיוון X קשר (offshore/onshore)
• עודכן לאחרונה: DD.MM.YYYY, HH:mm
...
- אם אירוע קיים ליום **והתנאים ירדו מתחת לסף**:
  - **אל תמחק** את האירוע
  - עדכן כותרת ל: "חלון גלישה - התנאים נחלשו"
  - עדכן תיאור בנתוני תחזית חדשים שמראים מדוע התנאים הידרדרו
  - שמור זמני אירוע מקוריים

### כלל 4: התאוששות
- אם אירוע קיים עם "התנאים נחלשו" **והתנאים חזרו להיות טובים**:
  - עדכן כותרת בחזרה ל: "חלון גלישה טוב - הרצליה"
  - עדכן תיאור בנתוני תחזית טובה חדשים

### כלל 5: אין אירוע
- אם אין אירוע ליום **והתנאים מתחת לסף** → אל תעשה כלום (שקט = לא טוב)

**עיקרון בסיסי:** אירועים מייצגים "מצאנו חלון טוב" לא "סטטוס יומי". ברגע שנוצר, אירוע נשאר (עם עדכוני סטטוס) עד שהוא עובר.
...
- עדכן אירועים קיימים במקום ליצור כפילויות
- עקוב אחר סטטוס אירוע באופן מרומז דרך הכותרת ("חלון גלישה טוב" לעומת "התנאים נחלשו")
...
- [ ] יכול ליצור אירוע חדש כשתנאים טובים (בעברית)
- [ ] יכול לעדכן אירוע קיים "טוב" בנתוני תחזית חדשים
- [ ] יכול להחליש אירוע ל"התנאים נחלשו" כשתנאים מחמירים
- [ ] יכול להחזיר אירוע מוחלש ל"טוב" כשתנאים משתפרים
