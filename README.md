...
- גובה swell: 0.8מ' - 2.5מ' (המערכת משתמשת ב-swell height, לא wave height)
- תקופת swell: ≥7 שניות (תקופה מותאמת דינמית לפי גובה הגל)
- מהירות רוח: <15 קשר
- כיוון רוח: חוף או חצי-חוף להרצליה (רוחות מערביות בדרך כלל חופיות)
- ציון איכות כולל: ≥65/100 (משוקלל: גובה 40%, תקופה 30%, רוח 20%, כיוון 10%)
